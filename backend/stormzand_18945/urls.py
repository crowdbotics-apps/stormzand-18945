"""stormzand_18945 URL Configuration
...
admin.site.site_header = "Stormzand"
admin.site.site_title = "Stormzand Admin Portal"
admin.site.index_title = "Stormzand Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Stormzand API",
        default_version="v1",
        description="API documentation for Stormzand App",
    ),
    public=True,
